...
/**
 * DestinocomunicacaoDestSearch represents the model behind the search form about `app\models\DestinocomunicacaoDest`.
 */
class DestinocomunicacaoDestSearch extends DestinocomunicacaoDest
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = DestinocomunicacaoDest::find();
        ...
        $query->andFilterWhere(['like', 'dest_hora', $this->dest_hora]);
