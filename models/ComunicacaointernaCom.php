...
/*Rules Personalizadas para a criação de CI relacionadas à Situação
        */
    ...
    public function validarSituacao($com_codsituacao, $params){
                ...
                {
                     if($this->$com_codsituacao == 2) //PARA CORREÇÃO
                     {
                         $this->addError($com_codsituacao, 'Não é possível colocar a CI para Correção uma vez que ainda estão sendo criadas.');                  
                     }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'com_titulo' => 'Título',
            'com_texto' => 'Texto',
            'com_codtipo' => 'Tipo de Comunicação',
